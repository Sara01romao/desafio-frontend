      ...
      <div className="bg-white max-w-[600px] w-full rounded-lg p-12">
        ...
        <form action="" className="flex flex-col gap-4">
          ...
          <div className="flex gap-6 items-center">
            <Input type="number" name="valueBuy" label="Valor de compra" placeholder="Valor de compra" />
            <h2 className="font-bold text-xl text-[#3A3A3A] max-w-[300px] w-full">BTC 0.12345</h2>
          </div>
          ...
          <div className="flex justify-end gap-4 mt-4">
            ...
            <Button type="button" className="bg-[#007BFF] text-white py-2 px-6 rounded-sm cursor-pointer hover:bg-[#0C9BF2]" >
              Adicionar
            </Button>
          </div>
        </form>
